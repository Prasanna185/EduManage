...
gulp.task('copy', function() {
    gulp.src(['bower_components/bootstrap/**/*', '!**/npm.js', '!**/bootstrap-theme.*', '!**/*.map'])
...
// Run everything
gulp.task('default', ['minify-css', 'img', 'minify-js', 'copy']);
...
gulp.task('dev', ['browserSync', 'less', 'minify-css', 'img', 'js', 'minify-js'], function() {
